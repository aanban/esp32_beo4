...
## 1.1 Beo4 Receive task [examples/esp32_beo4_rx](examples/esp32_beo4_rx)
...
## 1.2 Beo4 Transmit task [examples/esp32_beo4_tx](examples/esp32_beo4_tx)
There is also a working circuit for the IR transmitter. The use of 880nm IR diodes is recommended, in the B&O service manuals you will find references to receiver circuits operating at 880nm wavelength.

## 1.3 Home Assistant MQTT auto discovery [examples/esp32_beo4_HA](examples/esp32_beo4_HA)
Using the MQTT auto discovery feature for Home Assistant integration.

## 1.4 Home Assistant ESPHome device [examples/esp32_beo4_esphome](examples/esp32_beo4_esphome)
